...
const dictionaries: Record<Lang, Dict> = {
  ru: {
    ...
    "hero.subtitle":
      "Стратегическое руководство. Непредвзятые советы. Долгосрочная ценность — для инвесторов, выбирающих проекты DAMAC.",
    "hero.cta": "Узнать наш подход",
    "hero.cta2": "Получить подборку",

    "hero.feature.1.title": "Эксперты по DAMAC",
    "hero.feature.1.body": "Знание проектов и рынка изнутри.",
    "hero.feature.2.title": "Стратегическое сопровождение",
    "hero.feature.2.body": "Стратегии под ваши цели.",
    "hero.feature.3.title": "Управление рисками",
    "hero.feature.3.body": "Защита инвестиций и доходности.",
    "hero.feature.4.title": "Долгосрочная ценность",
    "hero.feature.4.body": "Устойчивый рост через недвижимость.",
    ...
    "form.name": "Имя",
    "form.phone": "Телефон",
    "form.phone.placeholder": "+971 50 123 4567",
    "form.email": "Email",
    "form.email.placeholder": "you@example.com",
    "form.message": "Сообщение",
    "form.message.placeholder": "Расскажите о своих целях: бюджет, сроки, площадь",
    "form.project": "Интересующий проект",
    "form.project.placeholder": "Например, DAMAC Bay 2",
  ...
  en: {
    ...
    "hero.subtitle":
      "Strategic guidance. Unbiased advice. Long-term value — for investors choosing DAMAC.",
    "hero.cta": "Discover Our Approach",
    "hero.cta2": "Request brochure",

    "hero.feature.1.title": "DAMAC Specialists",
    "hero.feature.1.body": "Deep project and market insight.",
    "hero.feature.2.title": "Strategic Guidance",
    "hero.feature.2.body": "Strategies tailored to your goals.",
    "hero.feature.3.title": "Risk Management",
    "hero.feature.3.body": "Protecting returns and investments.",
    "hero.feature.4.title": "Long-Term Value",
    "hero.feature.4.body": "Sustainable growth through real estate.",
    ...
    "form.message.placeholder": "Tell us about your goals: budget, timeline, size",
    "form.project": "Project of interest",
    "form.project.placeholder": "e.g. DAMAC Bay 2",
  ...
  ar: {
    ...
    "hero.subtitle":
      "توجيه استراتيجي. نصائح محايدة. قيمة طويلة الأمد — لمستثمري مشاريع داماك.",
    "hero.cta": "اكتشف نهجنا",
    "hero.cta2": "اطلب الكتيب",

    "hero.feature.1.title": "خبراء داماك",
    "hero.feature.1.body": "فهم عميق للمشاريع والسوق.",
    "hero.feature.2.title": "توجيه استراتيجي",
    "hero.feature.2.body": "استراتيجيات وفق أهدافك.",
    "hero.feature.3.title": "إدارة المخاطر",
    "hero.feature.3.body": "حماية استثماراتك وعوائدك.",
    "hero.feature.4.title": "قيمة طويلة الأمد",
    "hero.feature.4.body": "نمو مستدام عبر العقارات.",
    ...
    "form.message.placeholder": "أخبرنا عن أهدافك: الميزانية، الجدول الزمني، المساحة",
    "form.project": "المشروع المهتم به",
    "form.project.placeholder": "مثال: DAMAC Bay 2",
